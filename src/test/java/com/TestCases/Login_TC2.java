...
public class Login_TC2 extends BaseClass {
	...
	@Test(description="Login test with inValid emial and invalid password")
	public void LoginTest() {
		...
		if(EmailField==true)
		{
			Email.sendKeys("mail123@mail.com");
		}
		else {
		...
		{
			String Result="Login with valid credentails is Test fail";
		...
		{
			String Result="Login with invalid credentails is Test pass";
			System.out.println(Result);
